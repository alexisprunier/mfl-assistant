...
const Menu: React.FC<MenuProps> = (props) => {
  ...
  const getMenuLabel = (text, cl) => {
    return (
      <span
        className={
          "text-center d-none d-sm-block text-capitalize w-100 " +
  ...
  return (
    <nav id="Menu" className="navbar h-100 flex-lg-column">
        ...
        <ul className="navbar-nav flex-row flex-lg-column h4">
          <li className="nav-item">
            <Link to="/" className={"nav-link" + (location.pathname === "/" ? " active" : "")}>
              {location.pathname === "/" && getMenuLabel("Home", "d-none d-lg-inline")}
          ...
          <li className="nav-item">
            <Link to="/dash" className={"nav-link" + (location.pathname.startsWith("/dash") ? " active" : "")}>
              {location.pathname.startsWith("/dash") && getMenuLabel("Dashboard", "d-none d-lg-inline")}
              ...
              {location.pathname.startsWith("/dash") && getMenuLabel("", "d-inline d-lg-none")}
            </Link>
          </li>
          <li className="nav-item">
            <Link to="/tools" className={"nav-link" + (location.pathname.startsWith("/tools") ? " active" : "")}>
              {location.pathname.startsWith("/tools") && getMenuLabel("Tools", "d-none d-lg-inline")}
              <div className="px-2 px-lg-0">
              ...
              {location.pathname.startsWith("/tools") && getMenuLabel("", "d-inline d-lg-none")}
            </Link>
          </li>
          <li className="nav-item">
            <Link
            ...
            >
              {location.pathname.startsWith("/notification") && getMenuLabel("Notification", "d-none d-lg-inline")}
              <div className="px-2 px-lg-0">
              ...
              {location.pathname.startsWith("/notification") && getMenuLabel("", "d-inline d-lg-none")}
            </Link>
          </li>
          <li className="nav-item">
            <Link to="/map" className={"nav-link" + (location.pathname.startsWith("/map") ? " active" : "")}>
              {location.pathname.startsWith("/map") && getMenuLabel("Map", "d-none d-lg-inline")}
              <div className="px-2 px-lg-0">
              ...
              {location.pathname.startsWith("/map") && getMenuLabel("", "d-inline d-lg-none")}
            </Link>
          </li>
        </ul>
      </div>
      ...
      <div className="flex-grow-0">
        <div className="nav-item align-content-center">
          <ButtonLogin
            ...
            redirectToHq={true}
            content={
              <div className="Menu-login d-inline-block align-items-center text-center" title="Login">
                <div className="text-center">
                  <i className="bi bi-person lh-1 px-1"></i>
                  <div className="login-label d-block w-100 lh-1">LOGIN</div>
                </div>
              </div>
            }
          />
