    ...
    <nav className="MenuTop navbar justify-content-center justify-content-md-start w-100 p-2">
      <ul className="navbar-nav flex-row h6 ps-md-3">
        <li className="nav-item align-self-end lh-1 px-2">
          <Link
            to="player"
            className={"nav-link" + (["/notification/player"].indexOf(location.pathname) >= 0 ? " active" : "")}
          >
        ...
        <li className="nav-item align-self-end lh-1 px-2">
          <Link
            to="club"
            className={"nav-link" + (["/notification/club"].indexOf(location.pathname) >= 0 ? " active" : "")}
          >
        ...
        <li className="nav-item align-self-end lh-1 px-2">
          <Link to="report" className={"nav-link" + (location.pathname === "/notification/report" ? " active" : "")}>
