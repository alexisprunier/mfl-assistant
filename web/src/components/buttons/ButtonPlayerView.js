...
const ButtonPlayerView: React.FC<ButtonPlayerViewProps> = ({
  ...
  return (
    <div className="d-flex flex-row ms-md-2 border">
      <button
        className={
          "btn btn-small" + (!selectedView || selectedView === "profile" ? " btn-info text-white" : " text-info")
        }
      ...
      {displayPricing && (
        <button
          className={"btn btn-small" + (selectedView === "pricing" ? " btn-info text-white" : " text-info")}
      ...
      {displayOwner && (
        <button
          className={"btn btn-small" + (selectedView === "owner" ? " btn-info text-white" : " text-info")}
